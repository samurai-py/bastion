...
1. Gerar TOTP secret executando no shell: `python3 ~/.openclaw/workspace/skills/onboarding/totp.py generate`.
2. Gerar URI para QR code executando no shell: `python3 ~/.openclaw/workspace/skills/onboarding/totp.py qr <secret> <user.name>`.
...
6. Validar executando no shell: `python3 ~/.openclaw/workspace/skills/onboarding/totp.py verify <secret> <code>`.
