...
/// Kernel surface moved to `bastion_runtime::provider` (M2 step 3b): the
...
/// existing `crate::provider::...` path keeps compiling unchanged. The
/// OpenAI-compat translation helpers and error clarifiers below stay with the
/// concrete providers (they become `bastion-providers` in M2 step 4).
